...
category: 数论
tags: [质数, 筛法, 质数筛, 分段筛法, 二次筛法, 欧拉筛]
update_time: 2026-09-01
file_path: DataStructure/SegmentedSieve
---
...
分段筛法的时间复杂度取决于初筛使用的筛法和区间长度。设初筛使用的筛法事件负责度为 $P(n)$，区间长度为 $N$，则分段筛法的总时间复杂度为 $O(P(\sqrt R) + N \log \log R)$
